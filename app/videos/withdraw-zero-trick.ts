...
export const withdraw_zero_trick: Video = {
  index: 7,
  participants: {
    don: p.gZero,
    capos: [p.unspentTx, p.newman, p.lewis, p.cyclonator],
  },
  id: "dbwV8XoQu8E",
  title: "Withdraw Zero Trick",
  url: "https://www.youtube.com/watch?v=dbwV8XoQu8E",
  shorts: [],
  code: `
